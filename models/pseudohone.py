...
class PseudoHoner:
        ...
        while cur_pass < pass_at_k and not is_pass_train:
            ...
            while cur_iter < max_iters:
                ...
                generate_code_prompt = (
                    f"You are an expert Python programmer. Below is an algorithmic problem description and a high-level pseudocode (in LaTeX format using algorithm2e) for a correct solution.\n\n"
                    f"Problem Description: {raw_prompt}\n\n"
                    f"Corrected Pseudocode: {correct_chain_of_thought}\n\n"
                    f"Your task is to write full Python code that implements this pseudocode and solves the problem. "
    ...
    def think(self, cur_func_impl):
        ...
        think_prompt = (
            ...
            f"Your task is to generate **pseudocode** for this code in LaTeX format using the algorithm2e package. "
            f"This pseudocode should provide the high-level logic of the code. Format it as LaTeX pseudocode that captures the main steps and logic of the code."
        )
    ...
    def rethink(self, cur_func_impl, feedback_str, chain_of_thought_with_bugs):
        ...
        sketch_prompt = (
            f"You are an expert Python programmer. Below is an algorithmic problem description, the current pseudocode of the solution (which contains bugs), "
            f"the current code implementation, and the feedback from running the code.\n\n"
            f"Problem Description: {problem_description}\n\n"
            f"Current pseudocode (with Bugs) in LaTeX format: \n{chain_of_thought_with_bugs}\n\n"
            f"Current Code Implementation: {cur_code_implementation}\n\n"
            f"Feedback from the code execution: {failed_test}\n\n"
            f"Please rethink the approach and generate a new, corrected pseudocode for solving the problem referring to the bug explanation for this buggy pseudocode. "
            f"This new pseudocode should address the issues in the previous pseudocode, focus on outlining the corrected steps needed to solve the problem, and avoid the errors found in the previous pseudocode."
            f"Do not provide specific code, only pseudocode."
        )
